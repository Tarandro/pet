...
class BinaryPolarityProcessor(DataProcessor):
    """
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, BinaryPolarityProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, BinaryPolarityProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, BinaryPolarityProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, BinaryPolarityProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return BinaryPolarityProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                ...
                text_b = row[BinaryPolarityProcessor.TEXT_B_COLUMN] if BinaryPolarityProcessor.TEXT_B_COLUMN >= 0 else None
                example = InputExample(guid=guid, text_a=text_a, text_b=text_b, label=label)
                examples.append(example)
...
class ClassProcessor(DataProcessor):
    ...
    def __init__(self, TRAIN_FILE_NAME="train.csv", DEV_FILE_NAME="dev.csv", TEST_FILE_NAME="test.csv",
        ...
        # Set this to the name of the file containing the unlabeled examples
        self.UNLABELED_FILE_NAME = UNLABELED_FILE_NAME
        # Set this to a list of all labels in the train + test data
        self.LABELS = LABELS
        # Set this to the column of the train/test csv files containing the input's text a
        self.TEXT_A_COLUMN = TEXT_A_COLUMN
        # Set this to the column of the train/test csv files containing
        # the input's text b or to -1 if there is no text b
...
DEFAULT_METRICS = ["acc", "f1", "f1-macro"]
